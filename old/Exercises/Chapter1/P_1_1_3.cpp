...
std::vector<std::vector<float>> P_1_1_3::Solution(std::vector<float>& vector1, std::vector<float>& vector2, int exponent) {
    ...
    MyMath::scalarTimesVector(vector1, innerProduct);
...
bool P_1_1_3::Test1() {
    ...
    float exponent = 3;
    std::vector<std::vector<float>> answer = { {15.625f, -6.25, 0}, {0, 0, 0}, {-46.875f, 18.75f, 0} };
    std::vector<std::vector<float>> attempt = Solution(vec1, vec2, exponent);
